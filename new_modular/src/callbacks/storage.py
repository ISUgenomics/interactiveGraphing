...
#            print('1. -update ', str(len(loaded_files)))       #############
            ...
            for i in loaded_files:
                ...
                item = html.Div([
                  ...
                  generate_dbc_button(["edit ", html.I(className="fa fa-external-link")], {'type':"edit-",'id': str(i)}, n_clicks, "sm", True, "secondary", "ms-2 me-1 h34", style={'width':'20%'}),
                  dbc.Tooltip(children=tooltip['edit-'], target={'type':"edit-",'id': str(i)}, placement='bottom-start', style={'width': '400px'}),
                  generate_dbc_button([html.I(className="fa fa-times")], {'type':"remove-",'id': str(i)}, 0, "sm", True, "danger", "ms-1 me-2 h34", style={'width':'0', 'flex-grow': '1'}),
