...
ROOT_URLCONF = 'biograph.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'biograph', 'templates'),],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'biograph.context_processors.session_tabs',
            ],
        },
    },
]
...
WSGI_APPLICATION = 'biograph.wsgi.application'

ASGI_APPLICATION = 'biograph.asgi.application'
...
PLOTLY_DASH = {
    ...
    "stateless_loader" : "biograph.scaffold.stateless_app_loader",
    }
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'biograph', 'static'),]
...
SESSION_COOKIE_AGE = 3600  # OPTIONAL: 60 minutes