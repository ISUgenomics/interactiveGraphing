...
from sigloo.apps import explorer, synteny, demo_one, demo_two, demo_three, demo_four, demo_five, demo_six, demo_seven, demo_eight, demo_nine, demo_ten, demo_eleven
