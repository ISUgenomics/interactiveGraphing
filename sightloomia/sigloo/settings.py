"""
Django settings for sightloomia project.
...
ROOT_URLCONF = 'sigloo.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'sigloo' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'sigloo.wsgi.application'

ASGI_APPLICATION = 'sigloo.asgi.application'
...
PLOTLY_DASH = {
    ...
    "insert_demo_migrations" : False,  # Insert model instances used by the django-plotly-dash demo
    ...
    "stateless_loader" : "sigloo.views.stateless_app_loader",
    }
...
# Caching - app uses redis as this is present due to channels use
...
SESSION_COOKIE_AGE = 3600 #1209600				# two weeks
