...
from sigloo.apps.src.functions.widgets import get_triggered_info, get_triggered_dict, get_triggered_index
from sigloo.apps.src.params.generic import CONFIG
